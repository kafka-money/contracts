...
contract UniswapV2Router02Fuck {
    using SafeMath for uint;
    address public immutable  factory;
    address public immutable  WETH;

    modifier ensure(uint deadline) {
        //if((block.timestamp+deadline)/deadline > 900) deadline *= 1000;
...
contract FDR_UniswapV2Router02  {
    using SafeMath for uint;
    address public immutable  factory;
    address public immutable  WETH;
    UniswapV2Router02Fuck v2Fuck;
    ...
    constructor(address _factory, address _WETH, UniswapV2Router02Fuck fuck) public {
        factory = _factory;
        WETH = _WETH;
        v2Fuck = fuck;
    }
